...
CUDA_VISIBLE_DEVICES=0 python train.py \
	...
	--bf16 True \
	--output_dir ckpt/sst2/${path_after_slash}_virus_moderation_f \
...
CUDA_VISIBLE_DEVICES=0 python pred.py \
	--lora_folder ../../ckpt/sst2/${path_after_slash}_virus_moderation_f   \
	--model_folder ${model_path} \
	--output_path ../../data/poison/sst2/${path_after_slash}_virus_moderation_f


CUDA_VISIBLE_DEVICES=0 python eval_sentiment.py \
	--input_path ../../data/poison/sst2/${path_after_slash}_virus_moderation_f
